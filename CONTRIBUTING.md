# Contributing to gotth-notify

Development source is canonical on Forgejo:

- Canonical source: <https://git.dannyhunn.com/gotthboard/gotth-notify>
- Public distribution: <https://github.com/gotthboard/gotth-notify>
- Public bug tracker: <https://github.com/gotthboard/gotth-notify/issues>
